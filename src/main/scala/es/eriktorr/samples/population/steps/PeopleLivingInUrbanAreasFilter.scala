...
object PeopleLivingInUrbanAreasFilter {
  def peopleLivingInUrbanAreasFrom(cityPopulation: Seq[Dataset[CityPopulation]])(implicit spark: SparkSession): Dataset[CityPopulation] = {
